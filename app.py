...
def popular():
    ...
    return render_template('popular.html', reviews=popular_reviews,
                           categories=list(categories))
...
def your_reviews():
    ...
    return render_template('your_reviews.html', reviews=your_reviews,
                           categories=list(categories))
...
def recent():
    ...
    return render_template('recent.html', reviews=latest_reviews,
                           categories=list(categories))
